...
class Helper(object):
    HELP_M = '''```
❖ ᴄʜᴏᴏsє ᴛʜє ᴄᴧᴛєɢᴏʀʏ ғᴏʀ ᴡʜɪᴄʜ ʏᴏυ ᴡᴧηηᴧ ɢєᴛ ʜєʟᴩ```
**ᴧsᴋ ʏᴏυʀ ᴅᴏυʙᴛs ᴧᴛ sυᴘᴘᴏʀᴛ ᴄʜᴧᴛ ᴧʟʟ ᴄᴏᴍᴍᴧηᴅs ᴄᴧη ʙє υsєᴅ ᴡɪᴛʜ : /**
'''

    HELP_B = '''```
❖ ᴄʜᴏᴏsє ᴛʜє ᴄᴧᴛєɢᴏʀʏ ғᴏʀ ᴡʜɪᴄʜ ʏᴏυ ᴡᴧηηᴧ ɢєᴛ ʜєʟᴩ```
**ᴧsᴋ ʏσυʀ ᴅᴏυʙᴛs ᴧᴛ sυᴘᴘᴏʀᴛ ᴄʜᴧᴛ ᴧʟʟ ᴄᴏᴍᴍᴧηᴅs ᴄᴧη ʙє υsєᴅ ᴡɪᴛʜ : /**
'''


    HELP_Sona = '''```
❖ ʜєʟᴘ ϻᴧɪη ϻєηυ```
**❖ ᴄʜᴏᴏsє ᴛʜє ᴄᴧᴛєɢᴏʀʏ ғᴏʀ ᴡʜɪᴄʜ ʏᴏᴜ ᴡᴧηηᴧ ɢєᴛ ʜєʟᴩ**
'''
...
❍ /ask [ǫυєʀʏ] : sєᴧʀᴄʜ ᴛʜє ᴧηʏ ᴛʏᴘє ǫυєsᴛɪᴏη
...
'''
    ...
    HELP_02 = '''```
❖ sєᴧʀᴄʜ ᴄᴏᴍᴍᴧηᴅꜱ ❖```
**❍ /google [ǫυєʀʏ] : sєᴧʀᴄʜ ᴛʜє ɢᴏᴏɢʟє ғᴏʀ ᴛʜє ɢɪᴠєη ǫυєʀʏ
...
❖ 𝐏ᴏᴡᴇʀᴇᴅ 𝖡ʏ » [AarumiBots](https://t.me/AarumiBots)**
'''
