...
ASSUSERNAME = getenv("ASSUSERNAME" , "KARMA")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/EgoBots/bhumisong",)
...
autoclean = []
confirmer = {}
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/dahjy3.jpg")
